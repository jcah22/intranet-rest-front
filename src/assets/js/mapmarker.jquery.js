(function($){
	...
	function addMapMarker(map_element, opts){
		...
		var coords = opts.center.split(","),
			centerPoint = new google.maps.LatLng(20.0498898,-99.2607586);
		if(opts.styling) {
			var myMapStyles = [
		...
		var markerIcon = function() {
			var image = new google.maps.MarkerImage(
				...
				new google.maps.Point(20.0498898,-99.2607586),
		...
		$.each(opts.markers.markers, function(i, the_marker){
			...
			if(latitude!="19.513058333333333" && longitude!="-99.22860833333334"){
				var marker = new google.maps.Marker({
					map: map, 
					position: new google.maps.LatLng(20.0498898,-99.2607586),
					animation: google.maps.Animation.DROP,
					icon: icon,
					draggable: false,
					raiseOnDrag: false
		...
		$('#reset').click(function(){
			...
			map.setCenter(new google.maps.LatLng(20.0498898,-99.2607586));
      });
	}
